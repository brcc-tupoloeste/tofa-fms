...
function apiGetMemberObligations(memberId) {
  ...
  return apiGet('memberobligations', {
    memberId: memberId
  });
}
...
function apiRecordMemberPayment(data) {
  return apiPost('recordmemberpayment', data);
}

/** DASHBOARD SUMMARY */
function apiGetDashboardSummary(year) {
  return apiPost('dashboardsummary', {
    year: year
  });
}
